...
export type ProfileSectionId = 'profile' | 'username' | 'emailAddresses' | 'phoneNumbers' | 'connectedAccounts' | 'enterpriseAccounts' | 'web3Wallets' | 'password' | 'mfa' | 'activeDevices' | 'organizationProfile' | 'organizationDanger';
